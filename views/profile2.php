...
<!-- bootstrap-wysiwyg -->
<link href="<?php baseURL('third-party/thems/gentelella-rtl/vendors/google-code-prettify/bin/prettify.min.css')?>" rel="stylesheet">
<!-- Select2 -->
<link href="<?php baseURL('third-party/thems/gentelella-rtl/vendors/select2/dist/css/select2.min.css')?>" rel="stylesheet">
<!-- Switchery -->
<link href="<?php baseURL('third-party/thems/gentelella-rtl/vendors/switchery/dist/switchery.min.css')?>" rel="stylesheet">
<!-- starrr -->
<link href="<?php baseURL('third-party/thems/gentelella-rtl/vendors/starrr/dist/starrr.css')?>" rel="stylesheet">
            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="<?php baseURL('')?>third-party/thems/gentelella-rtl/build/images/img.jpg" alt="<?php baseURL('')?>third-party/thems/gentelella-rtl." class="img-circle profile_img">
                    </div>
            ...
            <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="جست و جو برای<?php baseURL('')?>third-party/thems/gentelella-rtl.">
                    ...
                    <div class="x_content">
                        <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                            ...
                            <ul class="list-unstyled user_data">
                                <li><i class="fa fa-map-marker user-profile-icon"></i> شاهرود، استان سمنان، ایران
                                </li>
                            ...
                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                ...
                                <div id="myTabContent" class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade active in" id="tab_content1"
                                        ...
                                        <ul class="messages">
                                            <li>
                                                <img src="<?php baseURL('')?>third-party/thems/gentelella-rtl/build/images/img.jpg" class="avatar" alt="Avatar">
...
<!-- morris.js -->
<script src="<?php baseURL('third-party/thems/gentelella-rtl/vendors/raphael/raphael.min.js')?>"></script>
<script src="<?php baseURL('third-party/thems/gentelella-rtl/vendors/morris.js/morris.min.js')?>"></script>
