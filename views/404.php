        ...
        <div class="col-md-12">
            <div class="col-middle">
                <div class="text-center text-center">
                    ...
                    <p>این صفحه که شما به دنبال آن هستید وجود ندارد <a href="#">گزارش مشکل؟</a>
                    </p>
...
<!-- jQuery -->
<script src="<?php baseURL('third-party/thems/gentelella-rtl/news/vendors/jquery/dist/jquery.min.js')?>"></script>
<!-- Bootstrap -->
