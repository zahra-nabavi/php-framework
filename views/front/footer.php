            ...
            <div class="row">
                ...
                <div class="col-md-3 col-xs-12 footer-widget">
                    ...
                    <div class="gallery-widget">
                        ...
                        <a href="#"><img class="img-responsive" src="<?php baseURL('third-party/thems/news/theme/images')?>/news/lifestyle/architecture1.jpg" alt=""></a>
                        <a href="#"><img class="img-responsive" src="<?php baseURL('third-party/thems/news/theme/images')?>/news/tech/gadget1.jpg" alt=""></a>
                        <a href="#"><img class="img-responsive" src="<?php baseURL('third-party/thems/news/theme/images')?>/news/tech/gadget2.jpg" alt=""></a>
                        <a href="#"><img class="img-responsive" src="<?php baseURL('third-party/thems/news/theme/images')?>/news/tech/game2.jpg" alt=""></a>
                        <a href="#"><img class="img-responsive" src="<?php baseURL('third-party/thems/news/theme/images')?>/news/tech/robot5.jpg" alt=""></a>
                        <a href="#"><img class="img-responsive" src="<?php baseURL('third-party/thems/news/theme/images')?>/news/lifestyle/travel5.jpg" alt=""></a>
                    </div>
                </div><!-- Col end -->
                ...
                <div class="col-md-12">
                    <div class="footer-info-content">
                        <div class="footer-logo">
                            <img class="img-responsive" src="<?php baseURL('third-party/thems/news/theme/images')?>/logos/footer-logo.png" alt="">
                        </div>
