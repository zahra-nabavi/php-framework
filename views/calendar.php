...
<head>
    ...
    <!-- FullCalendar -->
    <link href="<?php baseURL('third-party/thems/gentelella-rtl/vendors/fullcalendar/dist/fullcalendar.min.css')?>" rel="stylesheet">
    <link href="<?php baseURL('third-party/thems/gentelella-rtl/vendors/fullcalendar/dist/fullcalendar.print.css')?>" rel="stylesheet" media="print">
            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        <h3>تقویم
                            <small>برای افزودن و یا ویرایش کلیک کنید</small>
                        </h3>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">افزودن مورد جدید به تقویم</h4>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary antosubmit">ذخیره تغییرات</button>
                    </div>
                </div>
            </div>
        </div>
        <div id="CalenderModalEdit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title" id="myModalLabel2">ویرایش مورد در تقویم</h4>
                    </div>
                    <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default antoclose2" data-dismiss="modal">بستن</button>
                        <button type="button" class="btn btn-primary antosubmit2">ذخیره تغییرات</button>
                    </div>
                </div>
            </div>
        </div>
...
<!-- FullCalendar -->
<script src="<?php baseURL('third-party/thems/gentelella-rtl/vendors/fullcalendar/dist/fullcalendar.min.js')?>"></script>
<script src='<?php baseURL('third-party/thems/gentelella-rtl/vendors/fullcalendar/dist/lang/fa.js')?>'></script>
